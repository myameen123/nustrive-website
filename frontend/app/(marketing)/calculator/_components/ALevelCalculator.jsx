...
function AlevelCalculator() {
  ...
  const onCalculateHandler = () => {
    ...
    const matricPercentage = (matricObtained / matricTotal) * 25;
    const netPercentage = (netMarks / 200) * 75;
    const aggregate = (matricPercentage + netPercentage).toFixed(2);
      ...
      <div className=" w-full flex flex-col md:flex-row">
        ...
        <div className=" flex w-full gap-4 flex-col md:flex-row ">
          <TextField
            type="number"
            size="small"
            placeholder="Obtained Marks in Matric Eqv"
            fullWidth
          ...
          <TextField
            type="number"
            size="small"
            placeholder="Total Marks in Matric Eqv"
            fullWidth
...
export default AlevelCalculator;
