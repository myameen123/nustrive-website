...
function Service({service }) {
  ...
  // });
  return (
    <div className={`bg-[#CDCDCD]   rounded-[10px] pl-4 pt-4 pb-4 shadow-lg gap-6 md:gap-6 mx-auto  h-[200px]  md:w-[350px] w-[330px]`}> {/*${inView ? service.annimationClass : "opacity-0"} ref={ref} */}
