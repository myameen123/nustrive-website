...
const Teacher = ({teacher}) => {
  return (
    <div className="pb-2 mx-auto bg-[#ffffff]  rounded-[12px] flex flex-col items-start border border-2-[#E6E4FF] transition-shadow "> {/*h-[490px] */}
      <div className=''>
        <Image src={teacher.photo} alt="exam img" className="h-[20rem] w-auto rounded-[12px] " />
      </div>
