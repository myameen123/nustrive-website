...
function Testimonial({ testimonial }) {
  ...
  return (
    <div className="flex mt-[50px] flex-col gap-6 mb-20 group relative shadow-lg text-white rounded-xl px-6 py-8 h-[505px] md:h-[450px] md:w-[350px] w-[330px] cursor-pointer bg-[#b6def5] mx-auto">
