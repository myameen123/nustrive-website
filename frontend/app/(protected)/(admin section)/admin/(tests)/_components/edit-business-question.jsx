...
const EditBusinessQuestion = ({ question, closeModal, fetchQuestions }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/question/business/updateQuestion/${question._id}`,
        updatedQuestion,
        {
          headers: {
...
export default EditBusinessQuestion;
